CREATE TRIGGER [dbo].[trg_InvCustomers_Audit]
ON [dbo].[InvCustomers]
...
BEGIN
    ...
    INSERT INTO [dbo].[InvCustomers_Audit] (
        [CustomerCode], [CustomerName], [CustomerEmail], [ContactNo], [SecnContactNo],
        [CustomerAddress], [GST], [CustomerLogo], [CustomerLogoMime],
        [CreatedOn], [CreatedBy], [ModifiedOn], [ModifiedBy], [OperationType]
    )
    SELECT
        i.[CustomerCode], i.[CustomerName], i.[CustomerEmail], i.[ContactNo], i.[SecnContactNo],
        i.[CustomerAddress], i.[GST], i.[CustomerLogo], i.[CustomerLogoMime],
    ...
    SELECT
        d.[CustomerCode], d.[CustomerName], d.[CustomerEmail], d.[ContactNo], d.[SecnContactNo],
        d.[CustomerAddress], d.[GST], d.[CustomerLogo], d.[CustomerLogoMime],

/*
    Recalculates invoice GST and totals whenever line items are added.
*/
CREATE TRIGGER [dbo].[trg_AfterInsert_InvInvoiceItems]
...
BEGIN
    ...
    BEGIN
        EXEC [dbo].[usp_CalculateAndUpdateGST] @InvCode;
        FETCH NEXT FROM cur INTO @InvCode;
    END
